...
function showallskills(svgid, divid, hdiv) {
    document.getElementById(svgid).classList.toggle("active");
    document.getElementById(divid).classList.toggle("active");

    document.getElementById(hdiv).innerHTML = document.getElementById(svgid).classList.contains("active") ? "Show Less" : "Show All"
...
function Observe() {
    ...
    {
        threshold: 0.1,
        rootMargin: (-nav_height).toString() + "px 0px 0px 0px"
    })
